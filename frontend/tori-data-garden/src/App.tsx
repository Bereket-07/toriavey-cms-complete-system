            ...
            <Routes>
              ...
              <Route element={<RequireAuth />}>
                  ...
                  element={
                    <div className="min-h-screen flex w-full bg-background">
                      <div className="flex-1 flex flex-col w-full max-w-[100vw] overflow-x-hidden">
                        <CMSNavigation />
                        <main className="flex-1 w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-24 sm:pt-28">
                          <ErrorBoundary>
                            <Outlet />
                          </ErrorBoundary>
                        </main>
                ...
                >
                  ...
                  <Route
                    path="review-detail/:recipeId"
                    element={<WPRMReviewDetail />}
                  />
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-white/70 backdrop-blur-sm">
      <div className="flex flex-col items-center">
        <svg
          className="animate-spin h-10 w-10 text-[#7C9A6D] mb-2"
        ...
        <span className="text-[#7C9A6D] font-semibold">
          Loading analytics...
        </span>
      </div>
    </div>
